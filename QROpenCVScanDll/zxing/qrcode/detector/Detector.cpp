...
//this was giving an error isnan not declared in zxing. Changed to std::isnan from zxing::isnan. jsmith 22/6/20. Changed it back too hacky. Gotta be a better way.   
